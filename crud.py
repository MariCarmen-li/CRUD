...
#Función Post (Create). Es decir, crea un nuevo usuario
@app.post("/usersclass/")
...
async def usersclass(user:User):
    ...
    #http://127.0.0.1:8000/usersclass/
        ...
        #***Delete
@app.delete("/usersclass/{id}") #Aquí no es necesario poner todo el usuario, con el id basta para eoncontrarlo y eliminarlo
async def usersclass(id:int):
